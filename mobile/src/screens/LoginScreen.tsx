...
export default function LoginScreen({ onLoginSuccess, onNavigateToRegister }: Props) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Obtener saldo - si falla no bloqueamos el login
      try {
      ...
      if (err?.code === 'ERR_NETWORK' || err?.message === 'Network Error') {
        setError('El servidor esta iniciando. Espera unos segundos e intenta de nuevo.');
      } else {
      ...
      >
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity onPress={onNavigateToRegister}>
            <Text style={[styles.forgotText, { marginTop: spacing.sm }]}>
